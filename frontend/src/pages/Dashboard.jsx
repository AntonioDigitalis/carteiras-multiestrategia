    ...
    >
      ...
      {loading ? (
        ...
        <div className="space-y-1">
          ...
          />
          <MetricLine
            label={`vs CDI${metricas.retorno_acumulado_cdi != null ? ` (${fmtPct(metricas.retorno_acumulado_cdi)})` : ''}`}
            value={metricas.retorno_vs_cdi != null ? fmtPct(metricas.retorno_vs_cdi) : '—'}
